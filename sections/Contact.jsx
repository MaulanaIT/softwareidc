...
const Contact = () => {
    ...
    //   pake ini jika email error dikirim
    ...
    return (
        <>
            ...
            <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] px-5">
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <li>We would like to assure you that we will provide constructive feedback and offer relevant solution options to any questions posed. </li>


                                <p className="text-body-color mb-9 text-base leading-relaxed mt-3">
                                    IDC Software Labs proudly served clients seeking business digitization solutions with precision and excellence for over 3 years. We often meet clients in person and discuss.
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">
                                            Sulthan Residence Brebes No - D10 .Lembarawa . Brebes. Indonesia <span><a href="https://www.google.co.id/maps/place/Perumahan+Sulthan+Residence/@-6.9042251,109.0599665,16.5z/data=!4m6!3m5!1s0x2e6fbb7f9a65c127:0x26cac86b864fd11c!8m2!3d-6.9043562!4d109.0636928!16s%2Fg%2F11kd32l00d" target="blank"><u>View Map</u> </a> </span>
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">idc.softwarelab@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="relative rounded-lg  p-8  sm:p-12">
                                <form>
                                    ...
                                    <div>
                                        {contextHolder}
                                        <button type="button" className="flex justify-center items-center h-fit py-4 px-6 bg-[#25618B] rounded-[32px] gap-[12px] w-full" onClick={success}>
                                            <BiMailSend style={{ color: "white", fontSize: "30px" }} />
